...
Route::middleware(['auth', 'role:admin,super_admin', 'audit.admin'])->prefix('/admin-panel')->name('admin.')->group(function () {
    ...
    Route::post('/users/{user}/impersonate', [AdminManagementController::class, 'impersonateUser'])->name('users.impersonate');
    Route::post('/users/impersonate/stop', [AdminManagementController::class, 'stopImpersonate'])->name('users.impersonate.stop');
